...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap avatarBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.batman);
        Shader avatarShader = new BitmapShader(avatarBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        ...
        paint.setShader(new ComposeShader(avatarShader, logoShader, PorterDuff.Mode.DST_IN));
    }
